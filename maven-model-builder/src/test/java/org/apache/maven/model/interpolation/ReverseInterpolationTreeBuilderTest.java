...
public class ReverseInterpolationTreeBuilderTest
    extends TestCase
{

    public void testBuildTree() throws Exception {
        TestC test = new TestC();
        ReverseInterpolationTreeBuilder treeBuilder = new ReverseInterpolationTreeBuilder();

        ReverseInterpolationTreeBuilder.Elements elements = treeBuilder.buildTree( test );
    ...
    {
        ReverseInterpolationTreeBuilder treeBuilder = new ReverseInterpolationTreeBuilder();
        ReverseInterpolationTreeBuilder.Elements elements = treeBuilder.buildTree( sut );
    ...
    private ReverseInterpolationTreeBuilder.Interpolator simpleINterpolator()
    {
        return new ReverseInterpolationTreeBuilder.Interpolator()
        {
